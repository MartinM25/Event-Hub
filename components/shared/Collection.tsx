...
export const Collection = ({
  ...
  const containerClassName = specialPage ? "grid w-full grid-cols-1 gap-5 md: md:gap-4 lg:grid-cols-3" : "grid w-full grid-cols-1 gap-5 md:grid-cols-2 md:gap-4 lg:grid-cols-4"
